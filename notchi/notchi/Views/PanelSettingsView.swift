...
struct PanelSettingsView: View {
    ...
    private var systemSection: some View {
        VStack(alignment: .leading, spacing: SettingsLayout.sectionSpacing) {
            ...
            Button(action: toggleHideSpriteWhenIdle) {
                SettingsRowView(icon: "pip.exit", title: "Hide Emoji When Idle") {
    ...
    private func openGitHubRepo() {
        NSWorkspace.shared.open(URL(string: "https://github.com/SammyLin/VibeNotch")!)
    }

    private func openLatestReleasePage() {
        NSWorkspace.shared.open(URL(string: "https://github.com/SammyLin/VibeNotch/releases/latest")!)
    }
