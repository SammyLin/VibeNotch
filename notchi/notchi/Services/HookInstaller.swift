...
private let logger = Logger(subsystem: "com.vibenotch.app", category: "HookInstaller")
...
struct HookInstaller {
    ...
    static func installIfNeeded() -> Bool {
        ...
        let hookScript = hooksDir.appendingPathComponent("vibenotch-hook.sh")
        ...
        if let bundled = Bundle.main.url(forResource: "vibenotch-hook", withExtension: "sh") {
            do {
    ...
    private static func updateSettings(at settingsURL: URL) -> Bool {
        ...
        let command = "~/.claude/hooks/vibenotch-hook.sh"
                ...
                let hasOurHook = existingEvent.contains { entry in
                    if let entryHooks = entry["hooks"] as? [[String: Any]] {
                        return entryHooks.contains { h in
                            ...
                            return cmd.contains("vibenotch-hook.sh")
                        }
                    }
                    return false
                }
        ...
        do {
            ...
            logger.info("Updated settings.json with VibeNotch hooks")
            return true
        } catch {
        ...
        return hooks.values.contains { value in
            ...
            return entries.contains { entry in
                ...
                return entryHooks.contains { hook in
                    (hook["command"] as? String)?.contains("vibenotch-hook.sh") == true
                }
            }
        }
    }
    ...
    static func uninstall() {
        ...
        logger.info("Uninstalled VibeNotch hooks")
    }
}
