...
private let logger = Logger(subsystem: "com.vibenotch.app", category: "SocketServer")

typealias HookEventHandler = @Sendable (HookEvent) -> Void

final class SocketServer {
    static let socketPath = "/tmp/vibenotch.sock"
    ...
    private let serverQueue = DispatchQueue(label: "com.vibenotch.app.socket.server", qos: .userInitiated)
    private let clientQueue = DispatchQueue(label: "com.vibenotch.app.socket.client", qos: .userInitiated, attributes: .concurrent)
