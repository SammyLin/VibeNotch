...
private let logger = Logger(subsystem: "com.vibenotch.app", category: "StateMachine")

@MainActor
@Observable
final class VibeNotchStateMachine {
    static let shared = VibeNotchStateMachine()
    ...
    var currentState: VibeNotchState {
