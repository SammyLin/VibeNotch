#!/bin/bash
# VibeNotch Hook - forwards Claude Code events to VibeNotch app via Unix socket

SOCKET_PATH="/tmp/vibenotch.sock"
...
export VIBENOTCH_INTERACTIVE=$IS_INTERACTIVE
...
output = {
    ...
    'pid': None,
    'tty': None,
    'interactive': os.environ.get('VIBENOTCH_INTERACTIVE', 'true') == 'true',
